...
inoremap <leader>sysout System.out.println()<ESC>ha
...
"math symbols"
inoremap <leader>a α<ESC>la
inoremap <leader>b β<ESC>la
inoremap <leader>s Σ<ESC>la
inoremap <leader>e ε<ESC>la
